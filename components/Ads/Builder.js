import { Text, Box, Select, FormLabel, FormControl, Textarea, Input, Button, TableContainer, Thead, Td, Tr, Th, Tbody, Table, Accordion, AccordionItem, AccordionButton, AccordionPanel } from "@chakra-ui/react"
...
export default function Builder({ builderSelected }) {
    ...
    return <Box className={`${styles.builder} ${builderSelected ? '' : styles.noDisplay}`}>
